  ...
  var e = {
      ...
      5487: function () {
        ...
        window.tram = (function (e) {
          ...
          if (N.transition) {
            var C = N.timing.dom;
            if (((w.style[C] = f["ease-in-back"][0]), !w.style[C])) for (var F in d) f[F][0] = d[F];
          }
          var L = (t.frame =
              (u =
            ...
            P = (t.now =
              (l = (c = p.performance) && (c.now || c.webkitNow || c.msNow || c.mozNow)) && N.bind
                ? l.bind(c)
                : Date.now ||
                  function () {
                    return +new Date();
            ...
            V = s(function (t) {
              function a() {
                var e,
                  ...
                  n,
                  i = c.length;
                if (i) for (L(a), t = P(), e = i; e--;) (n = c[e]) && n.render(t);
              }
              ...
              ((t.init = function (e) {
                ...
                (t.stop = function () {
                  ...
                  this.active &&
                    ...
                    (n = e.inArray(this, c)) >= 0 &&
                      ((t = c.slice(n + 1)), (c.length = n), t.length && (c = c.concat(t))));
                }),
                (t.render = function (e) {
                  var t,
                    n = e - this.start;
                ...
                (t.format = function (e, t) {
                  ...
                  if (!this.unit) {
                    var i = t.replace(E, "");
                    (i !== e.replace(E, "") && o("Units do not match [tween]: " + t + ", " + e),
                      (this.unit = i));
                  }
                  ((t = parseFloat(t)),
                    (e = parseFloat(e)),
          ...
          var W = e.style,
            ...
            H = {
              ...
              "border-width": [x, _],
              "border-top-width": [x, _],
              "border-right-width": [x, _],
              "border-bottom-width": [x, _],
              "border-left-width": [x, _],
              "border-spacing": [x, _],
              "letter-spacing": [x, _],
              margin: [x, _],
              "margin-top": [x, _],
        ...
        (((i = {}).VERSION = "1.6.0-Webflow"),
          ...
          (i.template = function (e, t, n) {
            ...
            var r,
              a = RegExp(
                [
                  ((t = i.defaults({}, t, i.templateSettings)).escape || m).source,
            ...
            var c = t.variable;
            if (c) {
              if (!b.test(c)) throw Error("variable is not a bare identifier: " + c);
            } else ((u = "with(obj||{}){\n" + u + "}\n"), (c = "obj"));
            u =
                        ...
                        success:
                          ...
                          function (t) {
                            ...
                            ((t.thirdPartyCookiesSupported = n),
                              ...
                              e
                                .ajax({ type: "GET", url: r, dataType: "script", cache: !0 })
                                .then(a, d));
                          }),
                      });
                    }),
            ...
            return (
              /[?&](update)(?:[=&?]|$)/.test(u.search) || /\?update$/.test(u.href)
                ...
                : s
                  ? l()
                  : u.search
                    ? (/[?&](edit)(?:[=&?]|$)/.test(u.search) || /\?edit$/.test(u.href)) && l()
                    : a.on(c, f).triggerHandler(c),
              {}
            );
          }),
        );
                        ...
                        e.addEventListener(
                          ...
                          function (e) {
                            if (a(e.target)) {
                              ...
                              (t ||
                                ((i = (n = e.target).type),
                                ("INPUT" === (u = n.tagName) && r[i] && !n.readOnly) ||
      ...
      3949: function (e, t, n) {
        ...
        var _ = navigator.userAgent.toLowerCase(),
          ...
          b = (a.env.ios = /(ipod|iphone|ipad)/.test(_));
        ((a.env.safari = /safari/.test(_) && !v && !b),
          I &&
        ...
        ((a.resize = w(s, T)),
          ...
          (a.ready = function () {
            ((E = !0), h ? ((h = !1), p.each(o, y)) : p.each(u, A), p.each(c, A), a.resize.up());
          }),
          (a.load = function (e) {
            r.then(e);
          }),
                          ...
                          if (((s.href = i), !(i.indexOf(":") >= 0))) {
                            ...
                            "#" !== i &&
                              ...
                              E(
                                o,
                                f,
                                (!c && s.href === l.href) || i === a || (d.test(i) && p.test(a)),
                              );
                          }
                        }
                      })(t[o]);
                ...
                if ("" !== l) {
                  ...
                  d.length &&
                    ...
                    n.hash !== f &&
                      ...
                      (r.state && r.state.hash) !== f &&
                      r.pushState({ hash: f }, "", f),
      ...
      3946: function (e, t, n) {
        ...
        let a = n(7087),
          ...
          C = () => ({ type: l }),
          F = () => ({ type: s }),
          L = ({ rawData: e, defer: t }) => ({ type: f, payload: { defer: t, rawData: e } }),
          P = ({
          ...
          V = (e, t) => ({ type: _, payload: { key: e, value: t } }),
      ...
      1970: function (e, t, n) {
        ...
        let I = Object.keys(p.QuickEffectIds),
          ...
          { isPluginType: Y, createPluginInstance: H, getPluginDuration: q } = g.IX2VanillaPlugins,
          K = navigator.userAgent,
          Q = K.match(/iPad/i) || K.match(/iPhone/);
        function Z(e) {
          (C({ store: e, select: ({ ixRequest: e }) => e.preview, onChange: J }),
            C({ store: e, select: ({ ixRequest: e }) => e.playback, onChange: et }),
            C({ store: e, select: ({ ixRequest: e }) => e.stop, onChange: en }),
            C({ store: e, select: ({ ixRequest: e }) => e.clear, onChange: ei }));
        }
        ...
        function et(e, t) {
          ...
          if (
            ...
            (eg({ store: t, actionListId: i }), ed({ store: t, actionListId: i, eventId: a }));
            let e = eE({ store: t, eventId: a, actionListId: i, immediate: u, verbose: l });
            l &&
              e &&
              t.dispatch((0, E.actionListPlaybackChanged)({ actionListId: i, isPlaying: !u }));
          }
        }
                ...
                (ec(e),
                  (0, f.default)(n, (t, n) => {
                    ...
                    !(function ({ logic: e, store: t, events: n }) {
                      ...
                      (0, f.default)(s, (e, i) => {
                        let r = n[i],
                          { action: u, id: s, mediaQueries: f = c.mediaQueryKeys } = r,
                          { actionListId: d } = u.config;
                        (W(f, c.mediaQueryKeys) || t.dispatch((0, E.mediaQueriesDefined)()),
                          u.actionTypeId === p.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION &&
                            (Array.isArray(r.config) ? r.config : [r.config]).forEach((n) => {
                              let { continuousParameterGroupId: i } = n,
                                r = (0, o.default)(l, `${d}.continuousParameterGroups`, []),
                              ...
                              u &&
                                e.forEach((e, i) => {
                                  !(function ({
                                    ...
                                    U(E, r) && (v = G(t, v));
                                    let O =
                                      f.hasBoundaryNodes && n ? h.getClosestElement(n, T) : null;
                                    (I.forEach((e) => {
                                        ...
                                        if (
                                          ((m[o] = (function (e = [], t, n) {
                                            let i,
                                              r = [...e];
                                            return (
                                              r.some((e, n) => e.keyframe === t && ((i = n), !0)),
                                              null == i &&
                                                ((i = r.length),
                                                r.push({ keyframe: t, actionItems: [] })),
                                        ...
                                        let r = m[n],
                                          ...
                                          f = (
                                            s === p.ActionTypeConsts.PLUGIN_RIVE
                                              ? 0 === (u.config?.target?.selectorGuids || []).length
                                              : Y(s)
                                          )
                                            ? H(s)?.(t, u)
                                            : null,
                                          d = N({ element: t, actionItem: u, elementApi: h }, f);
                                        eh({
                                          store: e,
                                          element: t,
                                          eventId: i,
                          ...
                          (u.actionTypeId === p.ActionTypeConsts.GENERAL_START_ACTION ||
                            v(u.actionTypeId)) &&
                            ed({ store: t, actionListId: d, eventId: s }));
                      });
                      let g = (e) => {
                          ...
                          es(s, (a, o, u) => {
                            let l = n[o],
                              s = i.eventState[u],
                              { action: f, mediaQueries: d = c.mediaQueryKeys } = l;
                            ...
                            let g = (n = {}) => {
                              ...
                              z(i, s) || t.dispatch((0, E.eventStateChanged)(u, i));
                            };
                            f.actionTypeId === p.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION
                              ? (Array.isArray(l.config) ? l.config : [l.config]).forEach(g)
                              : g();
                          });
                        },
                        y = (0, d.default)(g, 12),
        ...
        function ec(e) {
          ...
          if (i !== t.viewportWidth) {
            ...
            e.dispatch((0, E.viewportWidthChanged)({ width: i, mediaQueries: t }));
          }
        }
        let el = (e, t) => (0, c.default)((0, s.default)(e, t), l.default),
          ...
          ef = (e) => S({ config: { target: e.target, targets: e.targets }, elementApi: h });
          ...
          if (l && l.useFirstGroupAsInitialState) {
            ...
            a.forEach((i) => {
              ...
              o.forEach((r) => {
                ...
                eh({
                  destination: N({ element: r, actionItem: i, elementApi: h }, o),
                  immediate: !0,
                  store: e,
                  element: r,
                  eventId: n,
        ...
        function ep({ store: e }) {
          ...
          (0, f.default)(t, (t) => {
            if (!t.continuous) {
              ...
              (ey(t, e),
                i &&
                  e.dispatch((0, E.actionListPlaybackChanged)({ actionListId: n, isPlaying: !1 })));
            }
          });
        }
        function eg({ store: e, eventId: t, eventTarget: n, eventStateKey: i, actionListId: r }) {
          let { ixInstances: a, ixSession: u } = e.getState(),
            c = u.hasBoundaryNodes && n ? h.getClosestElement(n, T) : null;
          (0, f.default)(a, (n) => {
            ...
            if (n.actionListId === r && n.eventId === t && u) {
              ...
              (ey(n, e),
                n.verbose &&
                  e.dispatch((0, E.actionListPlaybackChanged)({ actionListId: r, isPlaying: !1 })));
            }
          });
        }
        function eE({
          ...
          let { ixData: l, ixSession: s } = e.getState(),
            ...
            { actionItemGroups: g, useFirstGroupAsInitialState: E } = (0, o.default)(
              l,
              `actionLists.${r}`,
              {},
            );
          if (!g || !g.length) return !1;
          (a >= g.length && (0, o.default)(d, "config.loop") && (a = 0), 0 === a && E && a++);
          let y =
              (0 === a || (1 === a && E)) && v(d.action?.actionTypeId) ? d.config.delay : void 0,
            m = (0, o.default)(g, [a, "actionItems"], []);
          if (!m.length || !V(p, s.mediaQueryKey)) return !1;
          let _ = s.hasBoundaryNodes && n ? h.getClosestElement(n, T) : null,
            I = M(m),
            b = !1;
          return (
            m.forEach((o, l) => {
              ...
              g &&
                S({
                  ...
                  let g = p ? H(f)?.(s, o) : null,
                    E = p ? q(f)(s, o) : null;
                  b = !0;
                  let m = D({ element: s, actionItem: o }),
                    _ = N({ element: s, actionItem: o, elementApi: h }, g);
                  eh({
                    store: e,
                    element: s,
                    actionItem: o,
        ...
        function eh(e) {
          ...
          (C({ store: n, select: ({ ixInstances: e }) => e[d], onChange: e_ }),
            l || n.dispatch((0, E.instanceStarted)(d, y.tick)));
        }
        function ey(e, t) {
          em(document.body, "ix2-animation-stopping", { instanceId: e.id, state: t.getState() });
        ...
        function e_(e, t) {
          let {
            ...
            { events: T } = v,
            { mediaQueries: A = v.mediaQueryKeys } = T && T[f] ? T[f] : {};
          if (V(A, b.mediaQueryKey) && (i || n || r)) {
            if (l || (c === w && r)) {
              t.dispatch((0, E.elementStateChanged)(a, u, l, o));
              let { ixElements: e } = t.getState(),
                { ref: n, refType: i, refState: r } = e[a] || {},
                s = r && r[u];
              (i === O || Y(u)) && L(n, r, s, f, o, m, h, c, I);
            }
            if (r) {
              if (y) {
                let e = eE({
                ...
                _ &&
                  !e &&
                  t.dispatch((0, E.actionListPlaybackChanged)({ actionListId: g, isPlaying: !1 }));
              }
              ey(e, t);
            }
          }
      ...
      8955: function (e, t, n) {
        ...
        let {
          ...
          ea = (e) => {
            ...
            return ei(t.getBoundingClientRect(), { left: 0, top: o, right: i, bottom: r - o });
          },
          eo = (e) => (t, n) => {
            let { type: i } = t.nativeEvent,
              r = -1 !== [k, U].indexOf(i) ? i === k : n.isActive,
              a = { ...n, isActive: r };
          ...
          ec =
            ...
            (t, n = {}) => {
              ...
              let h = l === S ? p >= E + g : p <= E - g,
                y = { ...n, percentTop: p, inBounds: h, anchorTop: E, scrollingDown: i };
          ...
          ep = {
            ...
            handler:
              ...
              (e, t) => {
                ...
                return (
                  ((t ? n.elementVisible !== t.elementVisible : n.elementVisible) && i(e, n)) || n
                );
              }),
          },
          eg = {
            ...
            [P]: { types: "ecommerce-cart-close", handler: q(W, H) },
            [d]: {
              types: "click",
              handler: q(
                W,
              ...
              handler: (
                ...
                switch (o) {
                  ...
                  case u.EventBasedOn.PAGE: {
                    ...
                    _ = y ? Math.min(e + E, n) / n : Math.min(t + h, i) / i;
                    break;
                  }
                ...
                return (
                  ...
                  (o !== u.EventBasedOn.ELEMENT || v || v !== a.elementHovered) &&
                    ((_ = f ? 1 - _ : _), e.dispatch((0, l.parameterChanged)(I, _))),
                  { elementHovered: v, clientX: p, clientY: g, pageX: E, pageY: h }
                );
              },
            },
            [x]: {
            ...
            [F]: {
              ...
              handler: (
                ...
                if (d === u.EventBasedOn.VIEWPORT) {
                  ...
                  return (
                    e !== r.scrollPercent && t.dispatch((0, l.parameterChanged)(g, e)),
                    { scrollPercent: e }
                  );
                }
                {
                  ...
                  return (
                    p !== r.scrollPercent && t.dispatch((0, l.parameterChanged)(n, p)),
                    { scrollPercent: p }
                  );
                }
              },
      ...
      7718: function (e, t, n) {
        ...
        let i = n(7087),
          ...
          { getItemConfigByKey: h, getRenderType: y, getStyleProp: m } = r.IX2VanillaUtils,
          _ = (e, t) => {
            let n,
              i,
              r,
      ...
      4124: function (e, t, n) {
        ...
        let {
          ...
          ec = (e) => e.trim(),
          el = Object.freeze({ [ei]: F, [er]: L, [ea]: P }),
          es = Object.freeze({
        ...
        let em = (e, t) => e === t;
        function e_({ store: e, select: t, onChange: n, comparator: i = em }) {
        ...
        function ev({ config: e, event: t, eventTarget: n, elementRoot: i, elementApi: r }) {
          let a, o, u;
          ...
          if (v) return [ef.has(v) ? ef.get(v) : ef.set(v, {}).get(v)];
          ...
          if (
            (S
              ? ((a = A.limitAffectedElements), (o = R), (u = f(A)))
              : (o = u = f({ id: I, selector: b, selectorGuids: T })),
            t && w)
          ) {
            let e = n && (u || !0 === w) ? [n] : d(R);
            if (u) {
              if (w === k) return d(u).filter((t) => e.some((e) => y(t, e)));
              if (w === M) return d(u).filter((t) => e.some((e) => y(e, t)));
              if (w === x) return d(u).filter((t) => e.some((e) => m(e, t)));
            }
            return e;
          }
        ...
        let eT = /px/,
          eO = (e, t) =>
            t.reduce((e, t) => (null == e[t.type] && (e[t.type] = eD[t.type]), e), e || {}),
          ew = (e, t) =>
            t.reduce(
              (e, t) => (null == e[t.type] && (e[t.type] = ex[t.type] || t.defaultValue || 0), e),
              e || {},
            );
        ...
        let eS = (e, t) => (t && (e[t.type] = t.value || 0), e),
          ...
          eN = (e, t, n) => {
            ...
            switch (e) {
              ...
              case et: {
                let e = (0, u.default)(n.fontVariations, ({ type: e }) => e === t);
                return e ? e.value : 0;
              }
              default:
                return n[t];
          ...
          switch (c) {
            case W:
              ...
              let y = eU
                  .map((e) => {
                    ...
                    switch (e) {
                      ...
                      case K:
                        return `${_}(${n}${a}, ${i}${o}, ${r}${u})`;
                      case Q:
                        return `${I}(${n}${a}) ${v}(${i}${o}) ${b}(${r}${u})`;
                      case Z:
                        return `${T}(${n}${a}, ${i}${o})`;
                      default:
                        return "";
              ...
              (ej(s, g.TRANSFORM_PREFIXED, h),
                ...
                })(E, d) && A(s, g.TRANSFORM_STYLE_PREFIXED, O));
              return;
            case Y:
              return (function (e, t, n, i, r, a) {
                ...
                switch (i.actionTypeId) {
                  case en: {
                    ...
                    (void 0 !== o && (t === V && (t = "px"), ej(e, N, a), u(e, N, o + t)),
                      void 0 !== c && (r === V && (r = "px"), ej(e, C, a), u(e, C, c + r)));
                    break;
                  }
                  case ee:
                    var c = i.config;
                    let l = (0, o.default)(n, (e, t, n) => `${e} ${n}(${t}${ek(n, c)})`, ""),
                      { setStyle: s } = a;
                    (ej(e, S, a), s(e, S, l));
                    break;
                  case et:
            ...
            case z:
              ...
              if (L.actionTypeId === eo) {
                ...
                M(F, U, e === w && g.IS_BROWSER_ENV ? g.FLEX_PREFIXED : e);
              }
              return;
            case H: {
        ...
        function e$(e, t, n) {
          ...
          r(e, G) && eY({ effect: eB, actionTypeId: a, elementApi: n })(e);
        }
        let eY =
          ...
          b = (e = v, t = {}) => {
            switch (t.type) {
              case m:
                return v;
              case _: {
                let { elementId: n, element: i, origin: r, actionItem: o, refType: u } = t.payload,
                  { actionTypeId: c } = o,
                  l = e;
                return ((0, a.getIn)(l, [n, i]) !== i && (l = T(l, i, u, n, o)), O(l, n, c, r, o));
              }
              case I: {
        ...
        Webflow.require("ix2").init({
          events: {
            e: {
              ...
              target: {
                id: "69570ca8f9ee48a5ae6cb704|4e93d58e-73c2-1a0c-4d96-5f18e519242b",
                appliesTo: "ELEMENT",
                styleBlockIds: [],
              },
              targets: [
            ...
            "e-5": {
              ...
              mediaQueries: ["main", "medium", "small", "tiny"],
              target: { id: "69570ca8f9ee48a5ae6cb704", appliesTo: "PAGE", styleBlockIds: [] },
              targets: [{ id: "69570ca8f9ee48a5ae6cb704", appliesTo: "PAGE", styleBlockIds: [] }],
              config: {
                loop: !0,
                playInReverse: !1,
          ...
          actionLists: {
                    ...
                    },
                    {
                      ...
                      config: {
                        ...
                        target: {
                          ...
                          selector: ".prav-ruka",
                          selectorGuids: ["9ace091a-4ffa-acb6-4b0f-d439914985f9"],
                        },
                        xValue: 0,
                        yValue: 0,
                        xUnit: "deg",
            ...
            "a-4": {
                  ...
                  actionItems: [
                    {
                      ...
                      config: {
                        ...
                        duration: 0,
                        target: {
                          selector: ".strip-carouselu",
                          selectorGuids: ["ec3eb808-ee84-7eff-7966-d1d1f9a51dde"],
                        },
                        xValue: 0.01,
                        xUnit: "%",
                        yUnit: "PX",
              ...
              createdOn: 0x19b8645562d,
            },
            "a-3": {
              id: "a-3",
              title: "nač\xedtac\xed obrazovka DELAYED",
              actionItemGroups: [
                {
                  actionItems: [
                    {
                      ...
                      config: {
                        ...
                        duration: 0,
                        target: {
                          id: "69570ca8f9ee48a5ae6cb704|e173a967-1491-1bc5-5097-931e24b3e2c6",
                        },
                        value: 0,
                        unit: "",
                      },
                    ...
                    },
                    {
                      ...
                      config: {
                        ...
                        duration: 500,
                        target: {
                          id: "69570ca8f9ee48a5ae6cb704|ddc8c702-f95e-bce7-1b80-5954a9ae3071",
                        },
                        xValue: null,
                        yValue: 100,
                        xUnit: "vh",
                    ...
                    },
                    {
                      ...
                      config: {
                        ...
                        duration: 500,
                        target: {
                          id: "69570ca8f9ee48a5ae6cb704|4de8fa44-7862-4419-6aac-b71bc6f7e20c",
                        },
                        value: 0,
                        unit: "",
                      },
                  ...
                  actionItems: [
                    ...
                    },
                    {
                      ...
                      config: {
                        ...
                        duration: 3e3,
                        target: {
                          id: "69570ca8f9ee48a5ae6cb704|a29d7fb5-c890-8e22-d656-0e56e2935ff7",
                        },
                        value: 0,
                        unit: "",
                      },
              ...
              useFirstGroupAsInitialState: !0,
              createdOn: 0x19b863954d0,
            },
            "a-6": {
              id: "a-6",
              title: "nač\xedtac\xed obrazovka IMMEDIATE",
              actionItemGroups: [
                {
                  actionItems: [
                    {
                  ...
                  actionItems: [
                    {
                      ...
                      config: {
                        ...
                        duration: 500,
                        target: {
                          id: "69570ca8f9ee48a5ae6cb704|4e93d58e-73c2-1a0c-4d96-5f18e5192429",
                        },
                        zValue: 0,
                        xUnit: "DEG",
                        yUnit: "DEG",
